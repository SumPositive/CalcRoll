...
| 2.3.0 | 2026-05-24 | 文字サイズ対応（全画面・シート）、カスタムラジオボタン／プルダウン、数字フォント選択、入力行の表示改善（案C＋オートシュリンク）、fastlane によるメタデータ／スクリーンショット配信 |
| 2.3.1 | TBD | アプリアイコンを刷新（SVG ベース）。ja アプリ名も Calclin に統一。その他の修正・改善 |
